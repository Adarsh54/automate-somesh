...
export function createReelWorkspace({account,audioLibrary,esc,onChange}){
 ...
 let localUrls=[],publicationEpoch=0,pendingUploads=[];
 ...
 function reset(){pendingUploads=[];publicationEpoch++;clearPreview();publication=null;publicationLoaded=null;downloads=false;error='';notice='';}
