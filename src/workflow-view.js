...
export function workflowView(state, workflow, { esc, field, select }) {
  ...
  <details class="disclosure"><summary>File support & storage</summary><p class="muted">Desktop Chrome recommended. Codec support depends on the browser. No decodable audio track means an error, not invented results. Limit: 20 minutes per file. Drafts are saved on this device. Sign in and click Save project to store attached media privately; saved files restore after refresh. Unsaved media must be reattached. Cloud uploads support files up to 2 GB, within your available storage.</p></details></section>
