...
export function workflowView(state, workflow, { esc, field, select }) {
  ...
  <details class="disclosure"><summary>File support & storage</summary><p class="muted">MP4/AAC or WebM/Opus recommended for video; WAV, MP3, M4A, FLAC, or OGG for audio. Limit: 20 minutes per file. Files are uploaded privately for processing, including in guest mode. Temporary processing files expire after 24 hours and are removed by daily cleanup. Sign in and save your project to keep its media. Files must be under 2 GB and fit within available storage.</p></details></section>
