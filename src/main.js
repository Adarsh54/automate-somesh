...
function render() {
  ...
  $("#app").innerHTML =
    `<aside aria-label="Workspace sidebar"><div class="sidebar-header"><a class="brand" href="#" aria-label="Cuestamp"><span class="mark" aria-hidden="true">▥</span><span class="brand-word">cuestamp</span></a>${sidebarToggle}</div><div class="project-label">MUSIC WORKSPACE</div><nav id="sidebar-nav" aria-label="Workspace navigation">${steps
      .map(
        ([key, label], index) =>
