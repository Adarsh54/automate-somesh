...
function render() {
  ...
  document.querySelector("#sidebar-profile")?.insertAdjacentHTML("beforebegin", `<button class="nav credits-nav" data-tab="settings" aria-label="Credit profiles" title="Credit profiles">${sidebarIcon("settings")}<span class="nav-label">Credit profiles</span></button>`);
