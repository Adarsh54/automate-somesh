...
export const operations=['midi.import','session.set','track.add','track.set','track.delete','send.set','send.delete','send.automation.point','send.automation.clear','region.add','region.extractAudio','region.trim','region.set','region.delete','region.split','region.duplicate','event.add','event.set','event.delete','note.add','note.set','note.delete','notes.move','notes.resize','notes.delete','notes.duplicate','notes.quantize','notes.humanize','notes.transpose','marker.add','marker.delete','effect.add','effect.set','effect.delete','effect.move','automation.point','automation.set','automation.delete','automation.clear'];
