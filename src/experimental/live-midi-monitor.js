...
export function createLiveMidiMonitor(context, {destination=context.destination,maxVoices=64,instrument='triangle',sampleBuffer=null,sampleRoot=60,sampleLoop:loopEnabled=false,sampleLoopStart=0,sampleLoopEnd=null}={}) {
