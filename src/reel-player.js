...
export class ReelPlayer{
 ...
 durationSeconds(){return Number.isFinite(this.audio.duration)?this.audio.duration:(this.tracks[this.index]?.duration||0);}
 update(){
  const t=this.audio.currentTime||0,d=this.durationSeconds(),ratio=d?t/d:0;
